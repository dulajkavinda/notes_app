...
class SignInFormBloc extends Bloc<SignInFormEvent, SignInFormState> {
  ...
  Stream<SignInFormState> mapEventToState(
    ...
    }, passowrdChanaged: (e) async* {
      yield state.copyWith(
          password: Password(e.passwordStr),
          authFailureOrSuccessOption: none());
    },
        // registerWithEmailAndPasswordPress method implementation
        registerWithEmailAndPasswordPress: (e) async* {
      yield* _performActionOnAuthFacadeWithEmailAndPassword(
          _authFacade.registeWithEmailAndPassword);
    },
        // signInWithEmailAndPasswordPress method implementation
        signInWithEmailAndPasswordPress: (e) async* {
      yield* _performActionOnAuthFacadeWithEmailAndPassword(
          _authFacade.signInWithEmailAndPassword);
    },
        // signInWithGooglePress method implementation
